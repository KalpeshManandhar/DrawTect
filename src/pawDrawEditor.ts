...
export class PawDrawEditorProvider implements vscode.CustomEditorProvider<PawDrawDocument> {
	...
	async openCustomDocument(
		...
		listeners.push(document.onDidChangeContent(e => {
			...
			console.log("Update all webviews when the document changes");
	...
	private postMessage(panel: vscode.WebviewPanel, type: string, body: any): void {
		console.log("Post message to webview to that change");
	...
	private onMessage(document: PawDrawDocument, message: any) {
		switch (message.type) {
			case 'stroke':
				console.log("Stroke input from webview");
				console.log("Post message to document");
